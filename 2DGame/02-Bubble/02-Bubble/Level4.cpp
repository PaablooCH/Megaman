...
void Level4::init(Player* player)
{
	...
	enemy1->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, glm::vec2(49 * map->getTileSize(), 44 * map->getTileSize()), 20);
	enemy1->setPosition(glm::vec2(49 * map->getTileSize(), 44 * map->getTileSize()));
	enemy1->setTileMap(map);
	enemy1->setPlayer(this->player);
	enemy2 = new LinealEnemy();
	enemy2->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, glm::vec2(49 * map->getTileSize(), 19 * map->getTileSize()), 21);
	enemy2->setPosition(glm::vec2(49 * map->getTileSize(), 19 * map->getTileSize()));
	enemy2->setTileMap(map);
	enemy2->setPlayer(this->player);
	enemy3 = new LinealEnemy();
	enemy3->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, glm::vec2(8 * map->getTileSize(), 54 * map->getTileSize()), 22);
	enemy3->setPosition(glm::vec2(8 * map->getTileSize(), 54 * map->getTileSize()));
	enemy3->setTileMap(map);
	enemy3->setPlayer(this->player);
	enemy4 = new LinealEnemy();
	enemy4->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, glm::vec2(18 * map->getTileSize(), 42 * map->getTileSize()), 23);
	enemy4->setPosition(glm::vec2(18 * map->getTileSize(), 42 * map->getTileSize()));
	enemy4->setTileMap(map);
	enemy4->setPlayer(this->player);
	senemy2 = new ShootEnemy();
	senemy2->init(glm::ivec2(SCREEN_X, SCREEN_Y), texProgram, glm::vec2(38 * map->getTileSize(), 38 * map->getTileSize()), 90);
	senemy2->setPosition(glm::vec2(38 * map->getTileSize(), 38 * map->getTileSize()));
